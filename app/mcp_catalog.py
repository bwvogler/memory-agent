...
def summaries() -> str:
    ...
    return (
        ...
        f"{lines}\n\n"
        "These tools are already loaded and directly callable right now - there "
        "is no tool-search or deferred-loading step in this environment, and no "
        "such tool exists here to call. If a tool from this list does not appear "
        "to be available, that is a real defect: call the tool anyway and report "
        "what actually happens, rather than concluding it is unreachable.\n\n"
